...
public class SeventhTest {
    @Test
    public void test() {
        //this test works for the first starts run, but since we change Seventh class that extends Second class, Second class will need to be recompiled for the second run of STARTS which currently isn't being done.
