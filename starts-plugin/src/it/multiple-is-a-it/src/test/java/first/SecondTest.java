...
public class SecondTest {
    @Test
    public void test() {
        //this test works for the first starts run, but since we change Second class that extends First class, First class will need to be recompiled for the second run of STARTS which currently isn't being done.
