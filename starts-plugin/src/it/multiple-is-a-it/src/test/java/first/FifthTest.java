...
public class FifthTest {
    @Test
    public void test() {
        //this test works for the first starts run, but since we change Fifth class that extends Fourth class, Fourth class will need to be recompiled for the second run of STARTS which currently isn't being done.
